PATH = 'c:/Users/colez/Documents/VS python code/Discord bot/dictionary.txt'
def get_dict():
...
def list_names():
    with open('c:/Users/colez/Documents/VS python code/Discord bot/dictionary.txt', 'r', encoding='utf-8') as f:
        content = f.read()
    if not content:
        return ["Nothing"]
